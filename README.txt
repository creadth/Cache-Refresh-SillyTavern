...
2. It then schedules a series of refresh requests (up to the maximum number configured).
...
5. When the maximum number of refreshes is reached, the cycle stops until you send another message.
